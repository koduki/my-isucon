...
public class PgProxyPreparedStatement implements java.sql.PreparedStatement {
    private PreparedStatement proxy;

    public PgProxyPreparedStatement(PreparedStatement proxy) {
        this.proxy = proxy;
    }

    @Override
    public boolean execute(String sql) throws SQLException {
        System.out.println("execute sql2: " + sql);
